...
Button::Button(byte led, byte pin, byte command, byte value, byte channel, byte debounce)
{
  _pin = pin;
...
Button::Button(byte led, Mux mux, byte muxpin, byte command, byte value, byte channel, byte debounce)
{
  _pin = mux.outpin;
...
Event::Event(byte milli, byte command, byte value, byte channel)
{
  _recled = 1;
  _playled = 14;
  _milli = milli;
